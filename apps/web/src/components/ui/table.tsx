...
>(({ className, ...props }, ref) => (
  <div className="relative w-[calc(100%_-_4px)]">
    <table
      ref={ref}
      className={cn(
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'h-[60px] border-b transition-colors data-[state=selected]:bg-muted ',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'h-[60px] border-t-2 p-4 text-center align-middle [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
