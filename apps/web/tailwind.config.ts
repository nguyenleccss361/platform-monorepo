  ...
  theme: {
    extend: {
      colors: {
        ...
        hover: {
          secondary: 'hsl(var(--hover-secondary) / <alpha-value>)',
        },
        ...
        backgroundUpload: 'hsl(var(--background-upload) / <alpha-value>)',
        ...
        btn: 'hsla(var(--btn-hue), var(--btn-saturation), var(--btn-lightness), <alpha-value>)',
        search:
          'hsla(var(--search-hue), var(--search-saturation), var(--search-lightness), var(--search-alpha))',
      },
      fontFamily: {
